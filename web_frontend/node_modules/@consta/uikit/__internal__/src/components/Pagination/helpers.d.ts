...
import { PaginationArrowTypes, PaginationBaseItemDefault, PaginationItem, PaginationPropGetItemClickable, PaginationPropGetItemKey, PaginationPropGetItemLabel } from './types';
export declare const defaultGetItemLabel: PaginationPropGetItemLabel<PaginationBaseItemDefault>;
export declare const defaultGetItemKey: PaginationPropGetItemKey<PaginationBaseItemDefault>;
export declare const defaultGetItemClickable: PaginationPropGetItemClickable<PaginationBaseItemDefault>;
export declare const firstPageSeparator = "<_";
export declare const lastPageSeparator = "_>";
