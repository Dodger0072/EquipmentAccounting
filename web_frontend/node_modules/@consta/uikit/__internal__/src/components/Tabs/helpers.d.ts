...
import { TabDimensions, TabsDirection, TabsItemDefault, TabsPropFitMode, TabsPropGetItemAs, TabsPropGetItemAttributes, TabsPropGetItemDisabled, TabsPropGetItemIcon, TabsPropGetItemLabel, TabsPropGetItemRef, TabsPropGetItemSide, TabsPropLinePosition, TabsProps } from './types';
...
export declare const getTabsWrapper: (tabsDirection: TabsDirection, fitMode: TabsPropFitMode) => (<ITEM>({ items, tabsDimensions, tabRefs, getItemLabel, getItemChecked, renderItem, onChange, renderItemsList, size, }: import("./types").TabsFitModeWrapperProps<ITEM>) => import("react").ReactElement<any, string | import("react").JSXElementConstructor<any>> | null) | (<ITEM_1>({ renderItemsList, items, }: import("./types").TabsFitModeWrapperProps<ITEM_1>) => JSX.Element);
