...
export declare type InformerPropSize = typeof informerPropSize[number];
export declare const informerPropSiseDefault: InformerPropSize;
declare type Props = {
...
export declare type InformerProps = PropsWithHTMLAttributes<Props, HTMLDivElement>;
export declare const cnInformer: import("@bem-react/classname").ClassNameFormatter;
export declare const Informer: React.ForwardRefExoticComponent<Props & Omit<React.HTMLAttributes<HTMLDivElement>, "css" | keyof Props> & React.RefAttributes<HTMLDivElement>>;
export {};
