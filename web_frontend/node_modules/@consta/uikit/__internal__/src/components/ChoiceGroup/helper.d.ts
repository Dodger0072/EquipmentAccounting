...
export declare const withDefaultGetters: (props: ChoiceGroupProps) => {
    ...
    value?: import("./types").ChoiceGroupPropValue<ChoiceGroupDefaultItem, false> | undefined;
    onChange?: import("./types").ChoiceGroupPropOnChange<ChoiceGroupDefaultItem, false> | undefined;
