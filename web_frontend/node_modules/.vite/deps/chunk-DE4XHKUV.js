...
var Context = (0, import_react8.createContext)({ refs: [], zIndex: void 0 });
function usePortalContext() {
  return (0, import_react8.useContext)(Context);
}
var PortalWithThemeProvider = function(a) {
  var b = (0, import_react8.useState)([]), c = _slicedToArray(b, 2), d = c[0], e = c[1], f = usePortalContext(), g = f.addRefs;
  return (0, import_react8.useEffect)(function() {
    g && g(d);
  }, [d]), (0, import_react8.useEffect)(function() {
    return function() {
      return e([]);
    };
  }, []), import_react8.default.createElement(Context.Provider, { value: { refs: d, addRefs: function addRefs(a2) {
    if (0 < a2.length) {
...
var PortalWithTheme = import_react9.default.forwardRef(function(a, b) {
  var c = a.children, d = a.container, e = void 0 === d ? window.document.body : d, f = a.style, g = _objectWithoutProperties(a, _excluded), h = usePortalContext(), i = h.addRefs, j = h.zIndex, k = (0, import_react9.useRef)(null), l = getZIndex(j, null === f || void 0 === f ? void 0 : f.zIndex), m = _objectSpread(_objectSpread({}, f), {}, { zIndex: l });
  return (0, import_react9.useEffect)(function() {
    i && i([k]);
  }, [k]), import_react_dom3.default.createPortal(import_react9.default.createElement(PortalWithThemeProvider, { zIndex: l }, import_react9.default.createElement(Theme, Object.assign({}, g, { ref: useForkRef([k, b]), style: m }), c)), e);
});
...
// node_modules/@consta/uikit/__internal__/src/mixs/MixScrollBar/MixScrollBar.js
import "C:/EquipmentAccounting/web_frontend/node_modules/@consta/uikit/__internal__/src/mixs/MixScrollBar/MixScrollBar.css";
var cnScrollBar = cn("MixScrollBar");
var mixScrollBarPropSize = ["m", "xs", "s"];
var mixScrollBarPropSizeDefault = mixScrollBarPropSize[0];
var cnMixScrollBar = function(a) {
  var b = null !== a && void 0 !== a ? a : {}, c = b.size, d = void 0 === c ? mixScrollBarPropSizeDefault : c, e = b.invisible;
  return cnScrollBar({ size: d, invisible: e });
};
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-DE4XHKUV.js.map
