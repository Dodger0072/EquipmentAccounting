...
function e(e2, t2, n3, r2) {
  let o2 = [Te.mov({ store: e2.stateRef, to: "stack" }), Te.run({ fn: (e3) => t2(e3) })];
  if (r2 && o2.unshift(r2), n3) {
    let t3 = n({ node: o2, meta: { watchOp: "store" } }), r3 = e2.graphite.id, u3 = n3.additionalLinks, s2 = u3[r3] || [];
...
function n2(t2, n3) {
  ne.store(t2) || N2("expect useStore argument to be a store");
...
function r(t2, n3) {
  ...
  r2 ? o2 = { unit: t2 } : "@@unitShape" in t2 ? "function" == typeof t2["@@unitShape"] ? o2 = t2["@@unitShape"]() : N2("expect @@unitShape to be a function") : o2 = t2;
  let u3 = Array.isArray(o2), s2 = import_react.default.useRef({ stale: 1, justSubscribed: 0, scope: n3 }), [l2, a2, i3, c2, f2] = import_react.default.useMemo(() => {
    ...
    for (let s3 in o2) {
      let a3 = o2[s3];
      ne.unit(a3) || N2("expect useUnit argument to be a unit"), ne.event(a3) || ne.effect(a3) ? (e2[s3] = n3 ? N(a3, { scope: n3 }) : a3, u4.push(s3), l3.push(a3)) : (e2[s3] = null, t3.push(s3), r3.push(a3));
    }
...
function o([t2, n3], r2) {
  ...
  n3 ? (o2 = n3, s2 = t2, l2 = []) : { fn: o2, store: s2, keys: l2, defaultValue: u3, updateFilter: a2 = L } = t2, ne.store(s2) || N2("useStoreMap expects a store"), Array.isArray(l2) || N2("useStoreMap expects an array as keys"), "function" != typeof o2 && N2("useStoreMap expects a function");
  ...
  return K(i3, c2, c2, (e2) => {
    if (f2.current !== e2 || !((e3, t3) => {
      if (!e3 || !t3 || e3.length !== t3.length) return 0;
      let n4 = 1;
      for (let r3 = 0; r3 < e3.length; r3++) if (e3[r3] !== t3[r3]) {
        n4 = 0;
        break;
      }
      return n4;
...
function u2(e2, t2 = {}, n3) {
  ...
  O(() => (l2.open(a2.current.value), () => l2.close(a2.current.value)), [l2]), ((e3, t3) => {
    if (e3 === t3) return 1;
    if ("object" == typeof e3 && null !== e3 && "object" == typeof t3 && null !== t3) {
      let n4 = Object.keys(e3), r2 = Object.keys(t3);
      if (n4.length !== r2.length) return 0;
      for (let r3 = 0; r3 < n4.length; r3++) {
        let o3 = n4[r3];
        if (e3[o3] !== t3[o3]) return 0;
      }
      return 1;
    }
    return 0;
  })(a2.current.value, t2) || (a2.current.value = t2, a2.current.count += 1), O(() => {
    l2.set(a2.current.value);
  }, [a2.current.count]);
}
function s(e2) {
  let t2 = import_react.default.useContext(U);
  return e2 && !t2 && N2("No scope found, consider adding <Provider> to app root"), t2;
}
function l(e2, t2) {
  return ((e3, t3) => {
    if (!t3) return e3;
    ...
    return import_react.default.useMemo(() => {
      if (ne.unit(e3)) return N(e3, { scope: t3 });
      let n4 = Array.isArray(e3) ? [] : {};
      for (let r2 in e3) n4[r2] = N(e3[r2], { scope: t3 });
      return n4;
...
function f(e2, r2, u3) {
  return ((e3, r3, u4) => {
    let s2, l2, a2, i3 = [];
    "object" == typeof r3 && null !== r3 ? (r3.keys && (i3 = r3.keys), { fn: s2, getKey: l2, placeholder: a2 } = r3) : s2 = r3, ne.store(e3) || N2("expect useList first argument to be a store"), "function" != typeof s2 && N2("expect useList's renderItem to be a function"), Array.isArray(i3) || N2("expect useList's keys to be an array");
    let c2 = import_react.default.useMemo(() => {
      let n3 = t(`${e3.shortName || "Unknown"}.Item`, (t2) => {
        let { index: n4, keys: r4, keyVal: s3, value: l3 } = t2;
        if (f2.current[1]) return f2.current[0](l3, s3);
...
function d(e2, n3) {
  function r2(e3) {
    ...
    O(() => (s2({ props: t2.current, state: o2.getState() }), () => {
  ...
  let o2;
  ne.store(e2) ? o2 = e2 : "object" == typeof e2 && null !== e2 ? o2 = m(e2) : N2("shape should be a store or object with stores");
  let u3 = "Unknown";
...
function y(e2, t2) {
  ...
  })(G(r2 = n3) || /* @__PURE__ */ ((e3) => "function" == typeof e3)(r2));
...
var O = "undefined" != typeof window ? import_react.default.useLayoutEffect : import_react.default.useEffect;
var { useSyncExternalStore: M } = import_shim.default;
...
var W = (e2, t2 = {}) => (G(e2) && (W(e2.or, t2), ((e3) => {
  for (let o2 in e3) r2 = o2, /* @__PURE__ */ ((e4) => void 0 === e4)(n3 = e3[o2]) || "or" === r2 || "and" === r2 || (t2[r2] = n3);
  var n3, r2;
})(e2), W(e2.and, t2)), t2);
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6ZY3V6AZ.js.map
