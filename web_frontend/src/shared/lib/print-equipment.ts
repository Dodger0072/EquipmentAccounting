...
export const printEqupment = (equipmentList: Equipment[]) => {
  ...
  equipmentList.forEach((equipment) => {
    tableContent += `<tr><td style="padding: 8px; border: 1px solid #ddd;">${equipment.id}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.name}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.category}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.releaseDate}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.softwareStartDate}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.softwareEndDate}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.manufacturer}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.place_id}</td><td style="padding: 8px; border: 1px solid #ddd;">${equipment.waveRadius || ''}</td></tr>`;
  });
  tableContent += '</tbody>';
  tableContent += '</table>';
