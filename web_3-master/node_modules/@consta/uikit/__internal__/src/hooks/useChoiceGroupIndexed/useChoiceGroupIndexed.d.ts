...
export declare type UseChoiceGroupIndexedParams<MULTIPLE extends boolean = false, IS_NULLABLE_VALUE extends boolean = false, EVENT = React.MouseEvent<HTMLDivElement, MouseEvent>> = {
    value: (MULTIPLE extends true ? ValueMultiple : ValueNotMultiple<IS_NULLABLE_VALUE>) | undefined;
    multiple: MULTIPLE;
    callBack: (value: MULTIPLE extends true ? ValueMultiple : ValueNotMultiple<IS_NULLABLE_VALUE>, props: {
        e: EVENT;
    }) => void;
