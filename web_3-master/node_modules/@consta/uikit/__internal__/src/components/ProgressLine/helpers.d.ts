...
export declare function withDefaultGetters<ITEM>(props: ProgressLineProps<ITEM>): {
    getItemLabel: ProgressLinePropGetItemLabel<ProgressLineItemDefault> | ProgressLinePropGetItemLabel<ITEM>;
    size?: "s" | "m" | undefined;
