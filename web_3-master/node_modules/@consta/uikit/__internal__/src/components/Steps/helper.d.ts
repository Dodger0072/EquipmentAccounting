...
import { StepsItemDefault, StepsPropGetCompleted, StepsPropGetDisabled, StepsPropGetLabel, StepsPropGetSkipped, StepsProps } from './types';
export declare function withDefaultGetters(props: StepsProps): {
    getItemLabel: StepsPropGetLabel<StepsItemDefault>;
