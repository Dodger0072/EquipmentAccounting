...
export declare const withDefaultGetters: (props: SnackBarProps) => {
    ...
    getItemStatus: SnackBarPropGetItemStatus<SnackBarItemDefault>;
    getItemAutoClose: SnackBarPropGetItemAutoClose<SnackBarItemDefault>;
    getItemShowProgress: SnackBarPropGetItemShowProgress<SnackBarItemDefault>;
    getItemIcon: SnackBarPropGetItemIcon<SnackBarItemDefault>;
...
export declare const getItem: <ITEM>(item: ITEM, props: Required<Mappers<ITEM>> & {
    onItemClose?: ((item: ITEM) => void) | undefined;
    onItemAutoClose?: ((item: ITEM) => void) | undefined;
}) => {
    key: string | number;
