...
import { BreadcrumbsPropGetItemHref, BreadcrumbsPropGetItemIcon, BreadcrumbsPropGetItemLabel, BreadcrumbsPropGetItemOnClick, BreadcrumbsPropGetItemSubMenu, BreadcrumbsProps, DefaultItem } from './types';
export declare function withDefaultGetters(props: BreadcrumbsProps): {
    getItemLabel: BreadcrumbsPropGetItemLabel<DefaultItem>;
    getItemHref: BreadcrumbsPropGetItemHref<DefaultItem>;
    getItemOnClick: BreadcrumbsPropGetItemOnClick<DefaultItem>;
    getItemIcon: BreadcrumbsPropGetItemIcon<DefaultItem>;
