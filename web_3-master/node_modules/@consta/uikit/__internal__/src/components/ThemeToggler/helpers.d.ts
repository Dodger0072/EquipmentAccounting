...
import { ThemeTogglerItemDefault, ThemeTogglerPropGetItemIcon, ThemeTogglerPropGetItemKey, ThemeTogglerPropGetItemLabel, ThemeTogglerProps, ThemeTogglerPropSize } from './types';
export declare function withDefaultGetters(props: ThemeTogglerProps): {
...
export declare const iconSizeMap: Record<ThemeTogglerPropSize, IconPropSize>;
export declare const contextMenuSizeMap: Record<ThemeTogglerPropSize, ContextMenuPropSize>;
