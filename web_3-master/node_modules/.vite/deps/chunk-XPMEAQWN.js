...
function a(e2, t2) {
  let r2 = L(e2).meta || {};
  he = { id: L(e2).id, parent: he, value: e2, template: r2.template || be(), sidRoot: r2.sidRoot || he && he.sidRoot, meta: r2 };
  try {
    return t2();
  } finally {
    ye("region"), he = V(he);
...
function i(e2, r2, a2) {
  ...
  if (e2.target && (r2 = e2.params, a2 = e2.defer, n2 = e2.meta, i2 = "page" in e2 ? e2.page : i2, e2.stack && (o2 = e2.stack), l2 = G(e2) || l2, e2 = e2.target), l2 && et && l2 !== et && (et = null), Array.isArray(e2)) for (let t2 = 0; t2 < e2.length; t2++) Qe("pure", i2, L(e2[t2]), o2, r2[t2], l2, n2);
  else Qe("pure", i2, L(e2), o2, r2, l2, n2);
  if (a2 && !tt) return;
...
function u(e2, t2) {
  let r2 = gt({ or: t2, and: "string" == typeof e2 ? { name: e2 } : e2 }), a2 = (e3, ...t3) => (se(!J(a2, "derived"), "call of derived event", "createEvent"), se(!at, "unit call from pure function", "operators like sample"), nt ? ((e4, t4, r3, a3) => {
    let n2 = nt, i2 = null;
    if (t4) for (i2 = nt; i2 && i2.template !== t4; ) i2 = V(i2);
    lt(i2);
    let o3 = e4.create(r3, a3);
    return lt(n2), o3;
  })(a2, o2, e3, t3) : a2.create(e3, t3)), o2 = be(), l2 = Object.assign(a2, { graphite: n({ meta: $t(r2.actualOp || "event", a2, r2), regional: 1 }), create: (e3) => (i({ target: a2, params: e3, scope: et }), e3), watch: (e3) => Mt(a2, e3), map: (e3) => zt(a2, _, e3, [Le()]), filter: (e3) => zt(a2, "filter", e3.fn ? e3 : e3.fn, [Le(qe, 1)]), filterMap: (e3) => zt(a2, "filterMap", e3, [Le(), _e((e4) => !$e(e4), 1)]), prepend(e3) {
...
function p(e2, a2) {
  ...
  let y2 = J(m2, "serialize"), b2 = J(m2, "derived"), v2 = "ignore" === y2, k2 = J(m2, "sid");
  return k2 && (K(m2, "storeChange", 1), l2.sid = k2), k2 || v2 || b2 || K(m2, "warnSerialize", 1), r(b2 || !$e(e2), "current state can't be undefined, use null instead"), we(m2, [s2]), null != o2 && o2.domain && o2.domain.hooks.store(m2), b2 || (m2.reinit = u({ named: "reinit" }), m2.reset(m2.reinit)), l2.meta = m2.graphite.meta, ye(m2.graphite), m2;
}
function m(...e2) {
  let t2, a2, n2;
  [e2, n2] = f(e2);
...
function y(e2, t2 = {}) {
  ...
  let s2 = o2.finally = u({ named: "finally", derived: 1 }), f2 = o2.done = s2.filterMap({ named: "done", fn({ status: e3, params: t3, result: r2 }) {
    ...
    if (n2) {
      let e4 = n2.handlers.unitMap.get(o2) || n2.handlers.sidMap[o2.sid];
      e4 && (a3 = e4);
    }
  ...
  return we(o2, [s2, f2, d2, c2, m2, b2, y2]), null != a2 && a2.domain && a2.domain.hooks.effect(o2), o2;
}
function b(e2) {
  let t2;
  [e2, t2] = f(e2, 1);
...
function M(e2, a2) {
  let n2 = 0;
  return t(Nt, (t2) => {
    t2 in e2 && (r(null != e2[t2], Dt(a2, t2)), n2 = 1);
  }), n2;
}
function x(...e2) {
...
function z(t2, r2, a2) {
  if (Z(t2)) return se(0, "restore($store)"), t2;
  if (ee(t2) || te(t2)) {
...
function j(...t2) {
  ...
  let y2, b2 = new Set([].concat(l2, i2 || [], Object.values(a2))), v2 = Object.keys(m2 || g2 ? a2 : s2);
  if (m2 || g2) m2 && b2.add(s2), y2 = [m2 && Pe(W(s2), 0, 1), Fe({ safe: m2, filter: 1, pure: !m2, fn(e2, t3, r2) {
    let a3 = String(m2 ? r2.a : s2(e2));
    _t(t3, ie(v2, a3) ? a3 : "__", e2, r2);
  } })];
  else if (h2) {
    let t3 = Be({});
    t3.type = "shape";
    ...
    e(s2, (e2, n2) => {
      ...
      for (let n2 = 0; n2 < v2.length; n2++) {
        let i3 = v2[n2];
        if (ie(a3, i3) ? r3.a[i3] : s2[i3](e2)) return void _t(t4, i3, e2, r3);
      }
      _t(t4, "__", e2, r3);
    }, 1)];
  } else r(0, "expect match to be unit, function or object");
  let k2 = n({ meta: { op: o2 }, parent: i2 ? [] : l2, scope: a2, node: y2, family: { owners: Array.from(b2) }, regional: 1 });
  if (i2 && Rt(o2, i2, l2, null, k2, null, o2, c2, 0, 0, 0), !p2) return a2;
}
function C(e2, { scope: t2, params: r2 } = {}) {
  if (!X(e2)) return Promise.reject(new Error("first argument should be unit"));
  if (!(te(e2) || ee(e2) || Z(e2) || ae(e2))) return Promise.reject(new Error("first argument accepts only effects, events, stores or scopes"));
  ae(e2) && (t2 = e2);
  let a2 = h();
  a2.parentFork = et;
  let { fxCount: n2 } = t2;
...
function I(e2, a2) {
  let n2 = Array.isArray(e2) ? new Map(e2) : e2, i2 = /* @__PURE__ */ new Map(), o2 = 0;
  if (n2 instanceof Map) {
    let e3 = {};
    return t(n2, (t2, n3) => {
      r(X(n3), "Map key should be a unit"), a2 && a2(n3, t2), n3.sid && (n3.sid in e3 && (o2 = 1), e3[n3.sid] = t2), i2.set(n3, t2);
    }), { sidMap: e3, unitMap: i2, hasSidDoubles: o2 };
  }
...
function O(e2, a2) {
  ...
  let l2 = ((e3) => {
    let r2 = n({ scope: { defers: [], inFlight: 0, fxID: 0 }, node: [_e((e4, t2, r3) => {
    ...
    }), Fe({ priority: "sampler", batch: 1 }), _e((e4, r3) => {
      ...
      if ("current" in e4) return dt(nt, o3, null, e4).current;
      let t2 = L(e4);
  ...
  if (o2) {
    ...
    if (o2.values) {
      let { sidMap: e4, unitMap: a3, hasSidDoubles: n2 } = I(o2.values, (e5) => r(Z(e5), "Values map can contain only stores as keys"));
      Object.assign(l2.values.sidMap, e4), t(a3, (e5, t2) => {
        l2.values.idMap[t2.stateRef.id] = e5;
      }), l2.fromSerialize = !(Array.isArray(o2.values) || o2.values instanceof Map), l2.hasSidDoubles = n2;
    }
...
function q(e2, { values: a2 }) {
  ...
  ae(e2) ? (f2 = e2, u2 = 1, r(f2.cloneOf, "scope should be created from domain"), d2 = L(f2.cloneOf)) : re(e2) ? d2 = L(e2) : r(0, "first argument of hydrate should be domain or scope"), A(d2, (e3, t2) => {
    ...
    } else e3.scope.state.id in s2 && (le(c2, e3), le(p2, o2.get(s2[e3.scope.state.id])));
...
var ke = ({ sid: e2, name: t2, loc: r2, method: i2, fn: o2 }) => a(n({ meta: { sidRoot: ve(e2), sid: e2, name: t2, loc: r2, method: i2, type: "factory" } }), o2);
var we = (e2, r2) => {
  let a2 = L(e2);
  t(r2, (e3) => {
    let t2 = L(e3);
...
var Ne = (e2, t2, r2, a2) => {
  ...
  return r2 && (n2.order = { priority: r2 }, a2 && (n2.order.barrierID = ++De)), n2;
};
var De = 0;
...
var Fe = ({ fn: e2, batch: t2, priority: r2, safe: a2 = 0, filter: n2 = 0, pure: i2 = 0 }) => Ne("compute", { fn: e2, safe: a2, filter: n2, pure: i2 }, r2, t2);
var Ee = ({ fn: e2 }) => Fe({ fn: e2, priority: "effect" });
var _e = (e2, t2, r2) => Fe({ fn: e2, safe: 1, filter: t2, priority: r2 && "effect" });
var Pe = (e2, t2, r2) => Re({ store: e2, to: t2 ? P : "a", priority: r2 && "sampler", batch: 1 });
var Le = (e2 = qe, t2) => Fe({ fn: e2, pure: 1, filter: t2 });
var Te = { mov: Re, compute: Fe, filter: ({ fn: e2, pure: t2 }) => Fe({ fn: e2, filter: 1, pure: t2 }), run: Ee };
...
var Ge = [];
var Je = 0;
for (; Je < 6; ) le(Ge, { first: null, last: null, size: 0 }), Je += 1;
var Ke = () => {
...
var pt = (e2, r2, a2, n2, i2) => {
  ...
  let l2 = e2.reg;
  if (l2[r2.id]) return;
  let s2 = r2.sid, f2 = null == r2 || null === (o2 = r2.meta) || void 0 === o2 ? void 0 : o2.serialize, d2 = e2.fromSerialize && "ignore" !== f2 && (null == f2 ? void 0 : f2.read) || ct, u2 = { id: r2.id, current: r2.current, meta: r2.meta };
  if (u2.id in e2.values.idMap) u2.current = e2.values.idMap[u2.id];
  else if (s2 && s2 in e2.values.sidMap && !(s2 in e2.sidIdMap)) u2.current = d2(e2.values.sidMap[s2]);
    ...
    t(r2.before, (t2) => {
      switch (t2.type) {
        ...
        case "field":
          i3 || (i3 = 1, u2.current = Array.isArray(u2.current) ? [...u2.current] : { ...u2.current }), pt(e2, t2.from, a2, n2), o3 && (u2.current[t2.field] = l2[l2[t2.from.id].id].current);
      }
    });
  }
...
var yt = (e2, t2, r2) => {
  ...
  let n2 = B(e2);
  for (; a2 = n2.pop(); ) ht(a2, e2), (t2 || r2 && "sample" !== J(e2, "op") || "crosslink" === a2.family.type) && yt(a2, t2, "on" !== J(a2, "op") && r2);
  for (n2 = T(e2); a2 = n2.pop(); ) ht(a2, e2), r2 && "crosslink" === a2.family.type && yt(a2, t2, "on" !== J(a2, "op") && r2);
};
var bt = (e2) => e2.clear();
var vt = (e2, { deep: t2 } = {}) => {
  let r2 = 0;
  if (e2.ownerSet && e2.ownerSet.delete(e2), Z(e2)) bt(U(e2));
  else if (re(e2)) {
    r2 = 1;
    let t3 = e2.history;
...
var $t = (e2, t2, r2) => {
  let a2 = gt(r2), n2 = "domain" === e2, i2 = ue(), { sid: o2 = null, named: l2 = null, domain: f2 = null, parent: d2 = f2 } = a2, u2 = l2 || a2.name || (n2 ? "" : i2), c2 = s(u2, d2), p2 = { op: t2.kind = e2, name: t2.shortName = u2, sid: t2.sid = ve(o2), named: l2, unitId: t2.id = i2, serialize: a2.serialize, derived: a2.derived, config: a2 };
...
var Ct = (t2, a2, n2, i2, l2) => {
  ...
  let b2 = Re({ store: h2, to: "b", priority: "read" });
  b2.data.softRead = 1;
  let v2 = [_e((e2, t3, r2) => (r2.scope && !r2.scope.reg[c2.id] && (r2.c = 1), e2)), y2, Re({ store: m2, to: "b" }), _e((e2, { key: t3 }, r2) => {
    if (r2.c || e2 !== r2.a[t3]) return a2 && r2.b && (r2.a = s2(r2.a)), r2.a[t3] = e2, 1;
  }, 1), Re({ from: "a", target: c2 }), Re({ from: "value", store: 0, target: m2 }), Re({ from: "value", store: 1, target: m2, priority: "barrier", batch: 1 }), Pe(c2, 1), l2 && Le(), b2];
  return e(n2, (e2, t3) => {
    if (!Z(e2)) return r(!X(e2) && !$e(e2), `combine expects a store in a field ${t3}`), void (u2[t3] = f2[t3] = e2);
  ...
  }), g2.defaultShape = n2, He(h2, { type: _, from: c2, fn: l2 }), be() || (g2.defaultState = l2 ? h2.current = l2(u2) : f2), g2;
};
var At = (e2, t2, r2) => {
  try {
    return [1, e2(...r2)];
...
var Rt = (e2, t2, a2, n2, i2, o2, l2, s2, f2, c2, g2, h2) => {
  let y2 = !!i2;
  r(!$e(a2) || !$e(t2), Dt(e2, "either source or clock"));
  let b2 = 0;
  $e(a2) ? b2 = 1 : X(a2) || (a2 = m(a2)), $e(t2) ? t2 = a2 : (Ce(t2, e2, "clock"), Array.isArray(t2) && (t2 = S(t2))), b2 && (a2 = t2), s2 || l2 || (l2 = a2.shortName);
  let v2 = "none";
  (g2 || n2) && (X(n2) ? v2 = "unit" : (r(xe(n2), "`filter` should be function or unit"), v2 = "fn")), i2 ? (Ce(i2, e2, "target"), Ae(e2, i2)) : "none" === v2 && c2 && Z(a2) && Z(t2) ? i2 = p(o2 ? o2(We(W(a2)), We(W(t2))) : We(W(a2)), { name: l2, sid: h2, or: s2 }) : (i2 = u({ name: l2, derived: 1, or: s2 }), d("sampleTarget", L(i2)));
  let k2 = Be(), w2 = [];
  if ("unit" === v2) {
    let [r2, a3] = Et(n2, i2, t2, k2, e2);
    w2 = [...Ft(a3), ...Ft(r2)];
  }
  let [M2, x2] = Et(a2, i2, t2, k2, e2), $2 = wt(t2, i2, [d("sampleSourceLoader"), Re({ from: P, target: k2 }), ...Ft(x2), Pe(M2, 1, f2), ...w2, Pe(k2), "fn" === v2 && Le((e3, t3, { a: r2 }) => n2(e3, r2), 1), o2 && Le(Ie), d("sampleSourceUpward", y2)], e2, o2);
  return we(a2, [$2]), Object.assign($2.meta, s2, { joint: 1 }), i2;
};
var Ft = (e2) => [Pe(e2), _e((e3, t2, { a: r2 }) => r2, 1)];
...
//# sourceMappingURL=chunk-XPMEAQWN.js.map
